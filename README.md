# Шаблон для проектной работы cleanSassTemplate2.0
...
```sh
git clone https://github.com/AnatoliyNBulyga/cleanSassTemplate2.0.git
```

2. Переходим в созданную папку
```sh
cd cleanSassTemplate2.0
```
...
* В готовом проекте файлы стилей будут подключены отдельно по секциям и блокам
